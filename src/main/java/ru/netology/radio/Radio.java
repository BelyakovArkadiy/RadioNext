...
private int maxSound = 10;
    ...
    public int getCurrentChanelNext () {
        return currentChanel;
    }
    public int getCurrentChanelPrev () {
        return currentChanel;
    }
    ...
    public void setCurrentSoundPlus(int currentSound) {
    ...
    public void setCurrentSoundMinus(int currentSound) {
